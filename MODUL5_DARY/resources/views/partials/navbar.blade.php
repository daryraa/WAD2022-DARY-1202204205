    ...
    <div class="container">
        <div class="collapse navbar-collapse" id="navbarText">
            ...
            <span class="navbar-text">
                <div class="dropdown">
                    <button type="button" class="btn btn-light"><a style="text-decoration: none; color :black;"
                            href="/mycar/add">Add Car</a></button>
                    <button class="btn dropdown-toggle btn-light" type="button" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        {{ auth()->user()->name }}
                    </button>
